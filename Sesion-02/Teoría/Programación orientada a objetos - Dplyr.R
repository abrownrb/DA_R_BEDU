...
datos <- read.csv("/Users/aliciabrown/Documents/BEDU/A2-Programacion-con-R-master/Sesion-02/Teoría/data.csv", header=TRUE)
head(datos) # Para visualizar los primeros registros 
...
dplyr::select(datos, Indice, Estado, A2008)
...
select(datos, -starts_with("A")) # Esta funcion traera la informacion complementaria al comando anterior
...
arrange(datos, Indice1, A2002) # Por defecto, esta ordenacion es ascendente 
