...
# if (condicion o lo que revisa) { instrucciones o código que ejecuta}

# if (){}else{}
# if(){}else if(){} ...
# ifelse(condición, qué hacer en caso de sí, qué hacer en caso de no)
# ifelse(condición, qué hacer en caso de sí, 
#        ifelse(condición, qué hacer en caso de sí, qué hacer en caso de no))
# 
# while
# for
