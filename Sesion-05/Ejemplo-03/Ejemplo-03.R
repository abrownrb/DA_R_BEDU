...
# Adem�s, filtarmos renglones con Sepal.Length mayor o igual a 6 y Petal.Length mayor a 4.5
...
# Agregamos una columna que se llama Mult.Width que tenga la multiplicaci�n de Sepal.Width y Petal.Width
iris %>% 
